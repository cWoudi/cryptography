...
In particular, for the generation of the key, it will be necessary to use the [**Rabin-Miller**](./RM.md) algorithm for the generation of prime numbers.
...
#### Work to be done : 
- your programs, which must use the provided [library](./lib) for handling large integers
- a `Makefile`
